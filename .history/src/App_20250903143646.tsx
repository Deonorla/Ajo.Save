...
const DeyPlayLogo = () => (
  <motion.div className="flex items-center gap-3" whileHover={{ scale: 1.05 }}>
    ...
    <div className="flex items-baseline">
      ...
      <motion.span className="text-3xl font-black tracking-tight drop-shadow-lg text-rainbow-animated">
        .play
      </motion.span>
    </div>
  </motion.div>
  ...
  >
    ...
    <div className="relative z-10">
      <div className="flex items-center gap-4 mb-6">
        <div
          className="w-18 h-18 rounded-2xl flex items-center justify-center backdrop-blur-sm border border-white/20 shadow-lg"
      ...
      <h3 className="text-2xl font-bold text-white mb-4 drop-shadow-md leading-tight">
        {title}
      </h3>
      <p className="text-white/90 mb-6 leading-relaxed drop-shadow-sm text-base">
        {description}
      </p>
        ...
        {features.map((feature, index) => (
          ...
          >
            <div
              ...
              style={{ background: paintColor + "40" }}
            >
  ...
  <div className="relative rounded-2xl aspect-square overflow-hidden bg-black/40 border border-white/10">
    ...
    <div className="absolute inset-0 p-2 flex flex-col">
      <div className="flex justify-between">
        <span className="text-[10px] uppercase font-bold tracking-widest bg-black/50 px-1.5 py-1 rounded text-white">
          Mint
        </span>
  ...
  const tracks = [
    {
      ...
      description:
        "Digital Ajo meets blockchain magic. Build generational wealth the Yoruba way with transparent community savings, asset tokenization, and financial freedom.",
      features: [
        "Traditional Ajo on Hedera",
        "RWA tokenization for African assets",
        "Community microfinance pools",
    ...
    },
    {
      ...
      description:
        "Expose fake NGOs, churches, and charities with African precision. Every naira tracked, every lie exposed, every truth celebrated on-chain.",
      features: [
        "NGO transparency dashboards",
    ...
    },
    {
      ...
      description:
        "Mint Nigerian culture, celebrate our heritage through digital collectibles, virtual Owambe parties, and community-driven cultural preservation.",
      features: [
        "Cultural NFT collections",
        "Nigerian meme marketplace",
        "Virtual Owambe events",
        "Community cultural rewards",
      ],
    ...
    },
    {
      ...
      title: "AI & DePIN",
      description:
        "AI-powered fraud detection and decentralized infrastructure built specifically for Africa's digital revolution and economic transformation.",
      features: [
      ...
      <div className="min-h-screen bg-black text-white relative overflow-x-hidden">
        ...
        <section className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 relative z-20">
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              {" "}
              {/* Removed bottom margin for better vertical centering */}
              <motion.div
              ...
              >
                <span
                  className="text-sm sm:text-base font-black px-6 py-3 rounded-full border-2 shadow-lg"
                  style={{
                    borderColor: grimeColors.electricLime,
                    color: grimeColors.electricLime,
                    background: `${grimeColors.electricLime}20`,
                  }}
                >
              ...
              >
                Meme-heavy, Yoruba-coded, Lagos-loud. Track fraud, flex unity,
                and move money the Naija way: transparent NGOs & churches,
                digital Ajo, and community collectibles — all on Hedera.
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <motion.button
                  whileHover={{
                    scale: 1.05,
                    boxShadow: `0 10px 30px ${grimeColors.electricLime}40`,
                  }}
                  whileTap={{ scale: 0.95 }}
                ...
                <motion.button
                  whileHover={{
                    scale: 1.05,
                    boxShadow: `0 10px 30px ${grimeColors.hotMagenta}40`,
                  }}
                  whileTap={{ scale: 0.95 }}
                ...
                >
                  <Play
                    className="w-5 h-5"
                    style={{ color: grimeColors.hotMagenta }}
                  />
                  Watch Demo
                </motion.button>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-3 px-4 py-2 rounded-full bg-black/30 backdrop-blur-sm border border-white/10">
                  <div
                    ...
                    style={{ background: grimeColors.jadeGreen }}
                  />
                ...
                <div className="flex items-center gap-3 px-4 py-2 rounded-full bg-black/30 backdrop-blur-sm border border-white/10">
                  <div
                    className="w-3 h-3 rounded-full animate-pulse"
                    style={{ background: grimeColors.goldRush }}
                  />
          ...
          <div className=" mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
                Four powerful tracks, one mission: building transparent,
                wealthy, and unified Nigeria through blockchain technology and
                African innovation
              </p>
            </motion.div>
          ...
          <div className=" mx-auto">
            ...
            >
              <div className="flex items-center justify-center gap-2 mb-4">
                <Eye
                  className="h-8 w-8"
                  style={{ color: grimeColors.electricLime }}
                />
                <h2 className="text-4xl sm:text-5xl font-black tracking-tight text-rainbow-animated">
                  If you dey do good, make ledger show am.
                </h2>
              </div>
              <p className="text-xl text-white/80 max-w-3xl mx-auto leading-relaxed">
                Public, human‑readable receipts. Every donation, every spend,
                verifiable on Hedera. No long talk.
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  copy: "Immutable HCS messages + mirror queries.",
                },
                {
                  icon: BadgeCheck,
                  title: "Donor trust UI",
                  copy: "QR receipts, live inflow/outflow charts.",
                },
                {
                  icon: HeartHandshake,
                  title: "Community oversight",
                  copy: "Anonymous whistleblower with cryptographic proof.",
                },
              ].map((f, i) => (
                <motion.div
                  key={i}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                <div className="flex items-center gap-2 mb-6">
                  <HandCoins
                    className="h-8 w-8"
                    style={{ color: grimeColors.goldRush }}
                  />
                  <h2 className="text-4xl sm:text-5xl font-black tracking-tight text-rainbow-animated">
                    Ajo — round by round, everybody chop.
                  </h2>
                </div>
                <p className="text-xl text-white/80 mb-8 leading-relaxed">
                  Create a circle, set rounds, add members. Payouts rotate
                  automatically with transparent rules, dispute‑free.
                </p>
          ...
          <div className=" mx-auto">
            ...
            >
              <div className="flex items-center justify-center gap-2 mb-4">
                ...
                />
                <h2 className="text-4xl sm:text-5xl font-black tracking-tight text-rainbow-animated">
                  Collect the slang. Mint the memes.
                </h2>
              </div>
              <p className="text-xl text-white/80 max-w-3xl mx-auto leading-relaxed">
                Limited drops: dey play, sapa, lapo baby, more. Community‑priced
                mints with creator splits.
              </p>
            </motion.div>
          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-16 max-w-3xl mx-auto leading-relaxed">
                ...
                Every voice matters, every action counts, every truth shared
                makes us stronger.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-20">
                <motion.button
                  whileHover={{
                    scale: 1.05,
                    boxShadow: `0 20px 40px ${grimeColors.electricLime}40`,
                  }}
                ...
                <motion.button
                  whileHover={{
                    scale: 1.05,
                    boxShadow: `0 20px 40px ${grimeColors.hotMagenta}40`,
                  }}
                  whileTap={{ scale: 0.95 }}
        ...
        <footer className="bg-black py-16 px-4 sm:px-6 relative z-10 border-t border-white/10">
          <div className=" mx-auto text-sm text-gray-400 text-center">
            <DeyPlayLogo />
            <p className="mt-8 mb-4">© 2025 Dey.Play. All rights reserved.</p>
