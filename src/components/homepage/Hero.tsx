    ...
    <section className="relative min-h-screen bg-[#070101] overflow-hidden">
      <div className="w-full h-screen flex items-center relative px-16">
        ...
        <img
          ...
          className="absolute top-1/2 h-full w-full object-cover right-0 h-screen w-auto transform -translate-y-1/2 translate-x-[35%]"
        />
        
        {/* Hedera badge and tagline - positioned at top center */}
        <div className={`absolute top-8 left-1/2 transform -translate-x-1/2 z-10 text-center transition-all duration-1000 ${
